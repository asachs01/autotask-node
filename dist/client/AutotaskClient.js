...
class AutotaskClient {
    constructor(config, axiosInstance, performanceConfig, errorLogger) {
        this.config = config;
        ...
        this.requestHandler = new requestHandler_1.RequestHandler(this.axios, this.logger, {
     ...
     * ```
     */
    static async create(config, performanceConfig, errorLogger) {
        ...
        if (!config) {
            ...
            if (!config.username || !config.integrationCode || !config.secret) {
                throw new types_1.ConfigurationError('Missing required environment variables. Please set either:\n' +
            ...
            if (!config.username || config.username.trim() === '') {
                throw new types_1.ConfigurationError('Username is required and cannot be empty', 'username');
            }
            if (!config.integrationCode || config.integrationCode.trim() === '') {
                throw new types_1.ConfigurationError('Integration code is required and cannot be empty', 'integrationCode');
            }
            if (!config.secret || config.secret.trim() === '') {
                throw new types_1.ConfigurationError('Secret is required and cannot be empty', 'secret');
            }
        }
        ...
        if (!config.apiUrl) {
            try {
                ...
                const zoneResponse = await axios_1.default.get(`https://webservices.autotask.net/ATServicesRest/V1.0/zoneInformation?user=${encodeURIComponent(config.username)}`);
                ...
                const tempErrorLogger = errorLogger || ErrorLogger_1.defaultErrorLogger;
                ...
                const tempErrorLogger = errorLogger || ErrorLogger_1.defaultErrorLogger;
                const correlationId = tempErrorLogger.generateCorrelationId();
                tempErrorLogger.error('Failed to detect Autotask zone', error, {
                    correlationId,
                    operation: 'zone-detection',
                    request: {
                        url: `https://webservices.autotask.net/ATServicesRest/V1.0/zoneInformation?user=${encodeURIComponent(config.username)}`,
        ...
        try {
            ...
            const tempErrorLogger = errorLogger || ErrorLogger_1.defaultErrorLogger;
            const correlationId = tempErrorLogger.generateCorrelationId();
            tempErrorLogger.error('Failed to connect to Autotask API', error, {
                correlationId,
                operation: 'connection-test',
                request: {
                    method: 'GET',
     ...
     */
    async testAllSubClientConnections() {
        const results = {};
    ...
    get configurationItemNotes() {
        return this.getEntityFromSubClient('configuration', 'configurationItemNotes');
    }
    get articleNotes() {
    ...
    get contractNoteAttachments() {
        return this.getEntityFromSubClient('contractsClient', 'contractNoteAttachments');
    }
    get configurationItemNoteAttachments() {
        return this.getEntityFromSubClient('configuration', 'configurationItemNoteAttachments');
    }
    ...
    get contractBillingRules() {
        return this.getEntityFromSubClient('contractsClient', 'contractBillingRules');
    }
    get contractBlocks() {
        return this.getEntityFromSubClient('contractsClient', 'contractBlocks');
    }
    get contractBlockHourFactors() {
        return this.getEntityFromSubClient('contractsClient', 'contractBlockHourFactors');
    }
    get contractCharges() {
        return this.getEntityFromSubClient('contractsClient', 'contractCharges');
    }
    get contractExclusionBillingCodes() {
        return this.getEntityFromSubClient('contractsClient', 'contractExclusionBillingCodes');
    }
    get contractExclusionRoles() {
        return this.getEntityFromSubClient('contractsClient', 'contractExclusionRoles');
    }
    get contractExclusionSets() {
        return this.getEntityFromSubClient('contractsClient', 'contractExclusionSets');
    }
    get contractExclusionSetExcludedRoles() {
        return this.getEntityFromSubClient('contractsClient', 'contractExclusionSetExcludedRoles');
    }
    get contractExclusionSetExcludedWorkTypes() {
        return this.getEntityFromSubClient('contractsClient', 'contractExclusionSetExcludedWorkTypes');
    }
    ...
    get contractServiceAdjustments() {
        return this.getEntityFromSubClient('contractsClient', 'contractServiceAdjustments');
    }
    get contractServiceBundles() {
        return this.getEntityFromSubClient('contractsClient', 'contractServiceBundles');
    }
    get contractServiceBundleAdjustments() {
        return this.getEntityFromSubClient('contractsClient', 'contractServiceBundleAdjustments');
    }
    get contractServiceBundleUnits() {
        return this.getEntityFromSubClient('contractsClient', 'contractServiceBundleUnits');
    }
    get contractServiceUnits() {
        return this.getEntityFromSubClient('contractsClient', 'contractServiceUnits');
    }
    get contractTicketPurchases() {
        return this.getEntityFromSubClient('contractsClient', 'contractTicketPurchases');
    }
    get services() {
    ...
    get serviceBundleServices() {
        return this.getEntityFromSubClient('contractsClient', 'serviceBundleServices');
    }
    get serviceCalls() {
    ...
    get serviceCallTaskResources() {
        return this.getEntityFromSubClient('contractsClient', 'serviceCallTaskResources');
    }
    ...
    get serviceCallTicketResources() {
        return this.getEntityFromSubClient('contractsClient', 'serviceCallTicketResources');
    }
    get serviceLevelAgreementResults() {
        return this.getEntityFromSubClient('contractsClient', 'serviceLevelAgreementResults');
    }
    // Configuration items
    ...
    get configurationItemAttachments() {
        return this.getEntityFromSubClient('configuration', 'configurationItemAttachments');
    }
    get configurationItemBillingProductAssociations() {
        return this.getEntityFromSubClient('configuration', 'configurationItemBillingProductAssociations');
    }
    get configurationItemCategories() {
        return this.getEntityFromSubClient('configuration', 'configurationItemCategories');
    }
    get configurationItemCategoryUdfAssociations() {
        return this.getEntityFromSubClient('configuration', 'configurationItemCategoryUdfAssociations');
    }
    get configurationItemDnsRecords() {
        return this.getEntityFromSubClient('configuration', 'configurationItemDnsRecords');
    }
    get configurationItemRelatedItems() {
        return this.getEntityFromSubClient('configuration', 'configurationItemRelatedItems');
    }
    get configurationItemSslSubjectAlternativeName() {
        return this.getEntityFromSubClient('configuration', 'configurationItemSslSubjectAlternativeName');
    }
    get configurationItemTypes() {
        return this.getEntityFromSubClient('configuration', 'configurationItemTypes');
    }
    // Financial entities
    get billingCodes() {
    ...
    get billingItemApprovalLevels() {
        return this.getEntityFromSubClient('financial', 'billingItemApprovalLevels');
    }
    get invoices() {
    ...
    get purchaseOrderItemReceiving() {
        return this.getEntityFromSubClient('financial', 'purchaseOrderItemReceiving');
    }
    ...
    get additionalInvoiceFieldValues() {
        return this.getEntityFromSubClient('financial', 'additionalInvoiceFieldValues');
    }
    // Pricing entities
    ...
    get priceListWorkTypeModifiers() {
        return this.getEntityFromSubClient('financial', 'priceListWorkTypeModifiers');
    }
    ...
    get inventoryItemSerialNumbers() {
        return this.getEntityFromSubClient('inventory', 'inventoryItemSerialNumbers');
    }
    ...
    get inventoryStockedItemsRemove() {
        return this.getEntityFromSubClient('inventory', 'inventoryStockedItemsRemove');
    }
    get inventoryStockedItemsTransfer() {
        return this.getEntityFromSubClient('inventory', 'inventoryStockedItemsTransfer');
    }
    ...
    get resourceDailyAvailabilities() {
        return this.getEntityFromSubClient('timeTracking', 'resourceDailyAvailabilities');
    }
    get resourceTimeOffAdditional() {
        return this.getEntityFromSubClient('timeTracking', 'resourceTimeOffAdditional');
    }
    get resourceTimeOffApprovers() {
        return this.getEntityFromSubClient('timeTracking', 'resourceTimeOffApprovers');
    }
    get resourceTimeOffBalances() {
        return this.getEntityFromSubClient('timeTracking', 'resourceTimeOffBalances');
    }
    get timeOffRequests() {
        return this.getEntityFromSubClient('timeTracking', 'timeOffRequests');
    }
    get timeOffRequestsApprove() {
        return this.getEntityFromSubClient('timeTracking', 'timeOffRequestsApprove');
    }
    ...
    get documentChecklistLibraries() {
        return this.getEntityFromSubClient('knowledge', 'documentChecklistLibraries');
    }
    get documentConfigurationItemAssociations() {
        return this.getEntityFromSubClient('knowledge', 'documentConfigurationItemAssociations');
    }
    get documentConfigurationItemCategoryAssociations() {
        return this.getEntityFromSubClient('knowledge', 'documentConfigurationItemCategoryAssociations');
    }
    ...
    get documentTicketAssociations() {
        return this.getEntityFromSubClient('knowledge', 'documentTicketAssociations');
    }
    get documentToArticleAssociations() {
        return this.getEntityFromSubClient('knowledge', 'documentToArticleAssociations');
    }
    ...
    get articleConfigurationItemCategoryAssociations() {
        return this.getEntityFromSubClient('knowledge', 'articleConfigurationItemCategoryAssociations');
    }
    ...
    get articleTicketAssociations() {
        return this.getEntityFromSubClient('knowledge', 'articleTicketAssociations');
    }
    get articleToArticleAssociations() {
        return this.getEntityFromSubClient('knowledge', 'articleToArticleAssociations');
    }
    get articleToDocumentAssociations() {
        return this.getEntityFromSubClient('knowledge', 'articleToDocumentAssociations');
    }
    get checklistLibraries() {
        return this.getEntityFromSubClient('knowledge', 'checklistLibraries');
    }
    get checklistLibraryChecklistItems() {
        return this.getEntityFromSubClient('knowledge', 'checklistLibraryChecklistItems');
    }
    get tags() {
    ...
    get organizationalLevelAssociations() {
        return this.getEntityFromSubClient('configuration', 'organizationalLevelAssociations');
    }
    get organizatonalResources() {
        return this.getEntityFromSubClient('configuration', 'organizatonalResources');
    }
    ...
    get internalLocationWithBusinessHours() {
        return this.getEntityFromSubClient('configuration', 'internalLocationWithBusinessHours');
    }
    get countries() {
    ...
    get resourceRoleDepartments() {
        return this.getEntityFromSubClient('configuration', 'resourceRoleDepartments');
    }
    get resourceRoleQueues() {
        return this.getEntityFromSubClient('configuration', 'resourceRoleQueues');
    }
    get resourceServiceDeskRoles() {
        return this.getEntityFromSubClient('configuration', 'resourceServiceDeskRoles');
    }
    get actionTypes() {
    ...
    get userDefinedFieldDefinitions() {
        return this.getEntityFromSubClient('configuration', 'userDefinedFieldDefinitions');
    }
    get userDefinedFieldListItems() {
        return this.getEntityFromSubClient('configuration', 'userDefinedFieldListItems');
    }
    ...
    get contactBillingProductAssociations() {
        return this.getEntityFromSubClient('core', 'contactBillingProductAssociations');
    }
    get contactGroups() {
    ...
    get ticketAdditionalConfigurationItems() {
        return this.getEntityFromSubClient('core', 'ticketAdditionalConfigurationItems');
    }
    ...
    async createEntity(entityType, data) {
        ...
        const collection = this[mapping.collection];
...
//# sourceMappingURL=AutotaskClient.js.map