 ...
 */
class ContractBlocks extends base_1.BaseEntity {
    constructor(axios, logger, requestHandler) {
        super(axios, logger, requestHandler);
        this.endpoint = '/ContractBlocks';
    }
    static getMetadata() {
        return [
            {
     ...
     */
    async create(contractBlocks) {
        this.logger.info('Creating contractblocks', { contractBlocks });
        return this.executeRequest(async () => this.axios.post(this.endpoint, contractBlocks), this.endpoint, 'POST');
    }
    /**
...
exports.ContractBlocks = ContractBlocks;
//# sourceMappingURL=contractblocks.js.map