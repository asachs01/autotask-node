...
class Opportunities extends base_1.BaseEntity {
    ...
    async update(id, opportunities) {
        ...
        return this.executeRequest(async () => this.axios.put(`${this.endpoint}/${id}`, opportunities), `${this.endpoint}/${id}`, 'PUT');
    }
    /**
    ...
    async patch(id, opportunities) {
        ...
        return this.executeRequest(async () => this.axios.patch(`${this.endpoint}/${id}`, opportunities), `${this.endpoint}/${id}`, 'PATCH');
    }
    /**
