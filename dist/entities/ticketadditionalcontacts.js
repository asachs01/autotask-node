...
exports.TicketAdditionalContacts = void 0;
 ...
 */
class TicketAdditionalContacts extends base_1.BaseEntity {
    constructor(axios, logger, requestHandler) {
        super(axios, logger, requestHandler);
        this.endpoint = '/TicketAdditionalContacts';
    }
    static getMetadata() {
        return [
            {
     ...
     */
    async create(ticketAdditionalContacts) {
        this.logger.info('Creating ticketadditionalcontacts', { ticketAdditionalContacts });
        return this.executeRequest(async () => this.axios.post(this.endpoint, ticketAdditionalContacts), this.endpoint, 'POST');
    }
    /**
...
exports.TicketAdditionalContacts = TicketAdditionalContacts;
//# sourceMappingURL=ticketadditionalcontacts.js.map