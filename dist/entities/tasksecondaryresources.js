...
exports.TaskSecondaryResources = void 0;
 ...
 */
class TaskSecondaryResources extends base_1.BaseEntity {
    constructor(axios, logger, requestHandler) {
        super(axios, logger, requestHandler);
        this.endpoint = '/TaskSecondaryResources';
    }
    static getMetadata() {
        return [
            {
     ...
     */
    async create(taskSecondaryResources) {
        this.logger.info('Creating tasksecondaryresources', { taskSecondaryResources });
        return this.executeRequest(async () => this.axios.post(this.endpoint, taskSecondaryResources), this.endpoint, 'POST');
    }
    /**
...
exports.TaskSecondaryResources = TaskSecondaryResources;
//# sourceMappingURL=tasksecondaryresources.js.map