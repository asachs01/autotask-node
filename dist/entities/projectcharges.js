 ...
 */
class ProjectCharges extends base_1.BaseEntity {
    constructor(axios, logger, requestHandler) {
        super(axios, logger, requestHandler);
        this.endpoint = '/ProjectCharges';
    }
    static getMetadata() {
        return [
            {
     ...
     */
    async create(projectCharges) {
        this.logger.info('Creating projectcharges', { projectCharges });
        return this.executeRequest(async () => this.axios.post(this.endpoint, projectCharges), this.endpoint, 'POST');
    }
    /**
...
exports.ProjectCharges = ProjectCharges;
//# sourceMappingURL=projectcharges.js.map