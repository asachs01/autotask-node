...
exports.PriceListServices = void 0;
 ...
 */
class PriceListServices extends base_1.BaseEntity {
    constructor(axios, logger, requestHandler) {
        super(axios, logger, requestHandler);
        this.endpoint = '/PriceListServices';
    }
    static getMetadata() {
        return [
            {
     ...
     */
    async create(priceListServices) {
        this.logger.info('Creating pricelistservices', { priceListServices });
        return this.executeRequest(async () => this.axios.post(this.endpoint, priceListServices), this.endpoint, 'POST');
    }
    /**
...
exports.PriceListServices = PriceListServices;
//# sourceMappingURL=pricelistservices.js.map