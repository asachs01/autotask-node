...
class Appointments extends base_1.BaseEntity {
    ...
    async update(id, appointments) {
        ...
        return this.executeRequest(async () => this.axios.put(`${this.endpoint}/${id}`, appointments), `${this.endpoint}/${id}`, 'PUT');
    }
    /**
    ...
    async patch(id, appointments) {
        ...
        return this.executeRequest(async () => this.axios.patch(`${this.endpoint}/${id}`, appointments), `${this.endpoint}/${id}`, 'PATCH');
    }
    /**
