...
exports.ProjectNoteAttachments = void 0;
 ...
 */
class ProjectNoteAttachments extends base_1.BaseEntity {
    constructor(axios, logger, requestHandler) {
        super(axios, logger, requestHandler);
        this.endpoint = '/ProjectNoteAttachments';
    }
    static getMetadata() {
        return [
            {
     ...
     */
    async create(projectNoteAttachments) {
        this.logger.info('Creating projectnoteattachments', { projectNoteAttachments });
        return this.executeRequest(async () => this.axios.post(this.endpoint, projectNoteAttachments), this.endpoint, 'POST');
    }
    /**
...
exports.ProjectNoteAttachments = ProjectNoteAttachments;
//# sourceMappingURL=projectnoteattachments.js.map