...
exports.ArticleTagAssociations = void 0;
 ...
 */
class ArticleTagAssociations extends base_1.BaseEntity {
    constructor(axios, logger, requestHandler) {
        super(axios, logger, requestHandler);
        this.endpoint = '/ArticleTagAssociations';
    }
    static getMetadata() {
        return [
            {
     ...
     */
    async create(articleTagAssociations) {
        this.logger.info('Creating articletagassociations', { articleTagAssociations });
        return this.executeRequest(async () => this.axios.post(this.endpoint, articleTagAssociations), this.endpoint, 'POST');
    }
    /**
...
exports.ArticleTagAssociations = ArticleTagAssociations;
//# sourceMappingURL=articletagassociations.js.map