...
exports.TicketRmaCredits = void 0;
 ...
 */
class TicketRmaCredits extends base_1.BaseEntity {
    constructor(axios, logger, requestHandler) {
        super(axios, logger, requestHandler);
        this.endpoint = '/TicketRmaCredits';
    }
    static getMetadata() {
        return [
            {
     ...
     */
    async create(ticketRmaCredits) {
        this.logger.info('Creating ticketrmacredits', { ticketRmaCredits });
        return this.executeRequest(async () => this.axios.post(this.endpoint, ticketRmaCredits), this.endpoint, 'POST');
    }
    /**
...
exports.TicketRmaCredits = TicketRmaCredits;
//# sourceMappingURL=ticketrmacredits.js.map