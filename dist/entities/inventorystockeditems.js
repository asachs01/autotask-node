 ...
 */
class InventoryStockedItems extends base_1.BaseEntity {
    constructor(axios, logger, requestHandler) {
        super(axios, logger, requestHandler);
        this.endpoint = '/InventoryStockedItems';
    }
    static getMetadata() {
        return [
            {
...
exports.InventoryStockedItems = InventoryStockedItems;
//# sourceMappingURL=inventorystockeditems.js.map