 ...
 */
class BillingCodes extends base_1.BaseEntity {
    constructor(axios, logger, requestHandler) {
        super(axios, logger, requestHandler);
        this.endpoint = '/BillingCodes';
    }
    static getMetadata() {
        return [
            {
     ...
     */
    async create(billingCodes) {
        this.logger.info('Creating billingcodes', { billingCodes });
        return this.executeRequest(async () => this.axios.post(this.endpoint, billingCodes), this.endpoint, 'POST');
    }
    /**
     ...
     */
    async update(id, billingCodes) {
        this.logger.info('Updating billingcodes', { id, billingCodes });
        return this.executeRequest(async () => this.axios.put(`${this.endpoint}/${id}`, billingCodes), `${this.endpoint}/${id}`, 'PUT');
    }
    /**
     ...
     * @returns Promise with the updated billingcodes
     */
    async patch(id, billingCodes) {
        this.logger.info('Patching billingcodes', { id, billingCodes });
        return this.executeRequest(async () => this.axios.patch(`${this.endpoint}/${id}`, billingCodes), `${this.endpoint}/${id}`, 'PATCH');
    }
    /**
...
exports.BillingCodes = BillingCodes;
//# sourceMappingURL=billingcodes.js.map