 ...
 */
class QuoteTemplates extends base_1.BaseEntity {
    constructor(axios, logger, requestHandler) {
        super(axios, logger, requestHandler);
        this.endpoint = '/QuoteTemplates';
    }
    static getMetadata() {
        return [
            {
...
exports.QuoteTemplates = QuoteTemplates;
//# sourceMappingURL=quotetemplates.js.map