...
exports.TicketAdditionalConfigurationItems = void 0;
 ...
 */
class TicketAdditionalConfigurationItems extends base_1.BaseEntity {
    constructor(axios, logger, requestHandler) {
        super(axios, logger, requestHandler);
        this.endpoint = '/TicketAdditionalConfigurationItems';
    }
    static getMetadata() {
        return [
            {
     ...
     */
    async create(ticketAdditionalConfigurationItems) {
        this.logger.info('Creating ticketadditionalconfigurationitems', { ticketAdditionalConfigurationItems });
        return this.executeRequest(async () => this.axios.post(this.endpoint, ticketAdditionalConfigurationItems), this.endpoint, 'POST');
    }
    /**
...
exports.TicketAdditionalConfigurationItems = TicketAdditionalConfigurationItems;
//# sourceMappingURL=ticketadditionalconfigurationitems.js.map