...
class ServiceCallTasks extends base_1.BaseEntity {
    ...
    async update(id, serviceCallTasks) {
        ...
        return this.executeRequest(async () => this.axios.put(`${this.endpoint}/${id}`, serviceCallTasks), `${this.endpoint}/${id}`, 'PUT');
    }
    /**
    ...
    async patch(id, serviceCallTasks) {
        ...
        return this.executeRequest(async () => this.axios.patch(`${this.endpoint}/${id}`, serviceCallTasks), `${this.endpoint}/${id}`, 'PATCH');
    }
    /**
