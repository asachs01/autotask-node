...
class CompanyAlerts extends base_1.BaseEntity {
    ...
    async update(id, companyAlerts) {
        ...
        return this.executeRequest(async () => this.axios.put(`${this.endpoint}/${id}`, companyAlerts), `${this.endpoint}/${id}`, 'PUT');
    }
    /**
    ...
    async patch(id, companyAlerts) {
        ...
        return this.executeRequest(async () => this.axios.patch(`${this.endpoint}/${id}`, companyAlerts), `${this.endpoint}/${id}`, 'PATCH');
    }
    /**
