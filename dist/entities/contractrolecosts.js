...
exports.ContractRoleCosts = void 0;
 ...
 */
class ContractRoleCosts extends base_1.BaseEntity {
    constructor(axios, logger, requestHandler) {
        super(axios, logger, requestHandler);
        this.endpoint = '/ContractRoleCosts';
    }
    static getMetadata() {
        return [
            {
     ...
     */
    async create(contractRoleCosts) {
        this.logger.info('Creating contractrolecosts', { contractRoleCosts });
        return this.executeRequest(async () => this.axios.post(this.endpoint, contractRoleCosts), this.endpoint, 'POST');
    }
    /**
     ...
     */
    async update(id, contractRoleCosts) {
        this.logger.info('Updating contractrolecosts', { id, contractRoleCosts });
        return this.executeRequest(async () => this.axios.put(`${this.endpoint}/${id}`, contractRoleCosts), `${this.endpoint}/${id}`, 'PUT');
    }
    /**
     ...
     * @returns Promise with the updated contractrolecosts
     */
    async patch(id, contractRoleCosts) {
        this.logger.info('Patching contractrolecosts', { id, contractRoleCosts });
        return this.executeRequest(async () => this.axios.patch(`${this.endpoint}/${id}`, contractRoleCosts), `${this.endpoint}/${id}`, 'PATCH');
    }
    /**
...
exports.ContractRoleCosts = ContractRoleCosts;
//# sourceMappingURL=contractrolecosts.js.map