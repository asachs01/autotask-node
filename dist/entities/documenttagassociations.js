...
exports.DocumentTagAssociations = void 0;
 ...
 */
class DocumentTagAssociations extends base_1.BaseEntity {
    constructor(axios, logger, requestHandler) {
        super(axios, logger, requestHandler);
        this.endpoint = '/DocumentTagAssociations';
    }
    static getMetadata() {
        return [
            {
     ...
     */
    async create(documentTagAssociations) {
        this.logger.info('Creating documenttagassociations', { documentTagAssociations });
        return this.executeRequest(async () => this.axios.post(this.endpoint, documentTagAssociations), this.endpoint, 'POST');
    }
    /**
...
exports.DocumentTagAssociations = DocumentTagAssociations;
//# sourceMappingURL=documenttagassociations.js.map