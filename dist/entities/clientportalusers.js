...
exports.ClientPortalUsers = void 0;
 ...
 */
class ClientPortalUsers extends base_1.BaseEntity {
    constructor(axios, logger, requestHandler) {
        super(axios, logger, requestHandler);
        this.endpoint = '/ClientPortalUsers';
    }
    static getMetadata() {
        return [
            {
     ...
     */
    async create(clientPortalUsers) {
        this.logger.info('Creating clientportalusers', { clientPortalUsers });
        return this.executeRequest(async () => this.axios.post(this.endpoint, clientPortalUsers), this.endpoint, 'POST');
    }
    /**
     ...
     */
    async update(id, clientPortalUsers) {
        this.logger.info('Updating clientportalusers', { id, clientPortalUsers });
        return this.executeRequest(async () => this.axios.put(`${this.endpoint}/${id}`, clientPortalUsers), `${this.endpoint}/${id}`, 'PUT');
    }
    /**
     ...
     * @returns Promise with the updated clientportalusers
     */
    async patch(id, clientPortalUsers) {
        this.logger.info('Patching clientportalusers', { id, clientPortalUsers });
        return this.executeRequest(async () => this.axios.patch(`${this.endpoint}/${id}`, clientPortalUsers), `${this.endpoint}/${id}`, 'PATCH');
    }
    /**
...
exports.ClientPortalUsers = ClientPortalUsers;
//# sourceMappingURL=clientportalusers.js.map