...
export type QueueRequestStatus = 'pending' | 'processing' | 'completed' | 'failed' | 'retrying' | 'expired' | 'cancelled' | 'deferred';
...
export type QueueBatchStatus = 'collecting' | 'ready' | 'processing' | 'completed' | 'partial' | 'failed' | 'expired';
...
export type QueueEventType = 'request.enqueued' | 'request.processing' | 'request.completed' | 'request.failed' | 'request.retrying' | 'request.cancelled' | 'batch.created' | 'batch.processing' | 'batch.completed' | 'batch.failed' | 'queue.full' | 'queue.empty' | 'health.degraded' | 'health.recovered' | 'metrics.updated';
