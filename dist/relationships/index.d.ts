...
export declare class AutotaskRelationshipSystem {
    constructor(client?: any, config?: AutotaskRelationshipSystemConfig);
    getStats(): RelationshipSystemStats;
...
export declare class BatchRelationshipProcessor {
    constructor(mapper?: RelationshipMapper, loadingEngine?: SmartLoadingEngine, cascadeEngine?: CascadeEngine, logger?: any, options?: BatchRelationshipProcessorOptions);
}
export declare enum IntegrityIssueSeverity {
    INFO = "info",
    WARNING = "warning",
    ERROR = "error",
    CRITICAL = "critical"
}
export declare enum IntegrityViolationType {
...
export declare class IntegrityCheckResultBuilder {
