...
class PerformanceMonitor {
     ...
     */
    checkPerformanceThresholds(timing) {
    ...
    logSummary() {
        ...
        this.logger.info('Performance Summary', {
            ...
            successRate: ((report.metrics.successCount / report.metrics.requestCount) *
                100).toFixed(2),
