...
describe('ServiceCalls Entity', () => {
  ...
  describe('list', () => {
    it('should list servicecalls successfully', async () => {
      ...
      expect(setup.mockAxios.get).toHaveBeenCalledWith('/ServiceCalls/query', {
  ...
  describe('get', () => {
    it('should get servicecalls by id', async () => {
      ...
      expect(result.data).toEqual(mockData);
      expect(setup.mockAxios.get).toHaveBeenCalledWith('/ServiceCalls/1');
    });
  });
  ...
  describe('create', () => {
    it('should create servicecalls successfully', async () => {
      ...
      expect(setup.mockAxios.post).toHaveBeenCalledWith('/ServiceCalls', serviceCallsData);
    });
  });
  ...
  describe('update', () => {
    it('should update servicecalls successfully', async () => {
      ...
      expect(result.data).toEqual(mockResponse);
      expect(setup.mockAxios.put).toHaveBeenCalledWith('/ServiceCalls/1', serviceCallsData);
    });
  });
  ...
  describe('patch', () => {
    it('should partially update servicecalls successfully', async () => {
      ...
      expect(result.data).toEqual(mockResponse);
      expect(setup.mockAxios.patch).toHaveBeenCalledWith('/ServiceCalls/1', serviceCallsData);
    });
  });
  ...
  describe('delete', () => {
    it('should delete servicecalls successfully', async () => {
      ...
      expect(setup.mockAxios.delete).toHaveBeenCalledWith('/ServiceCalls/1');
    });
  });
});