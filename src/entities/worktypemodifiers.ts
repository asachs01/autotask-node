 ...
 */
export class WorkTypeModifiers extends BaseEntity {
  private readonly endpoint = '/WorkTypeModifiers';
  ...
  static getMetadata(): MethodMetadata[] {
    return [
      {
        operation: 'getWorkTypeModifiers',
        requiredParams: ['id'],
        optionalParams: [],
        returnType: 'IWorkTypeModifiers',
        endpoint: '/WorkTypeModifiers/{id}',
      },
      {
        operation: 'listWorkTypeModifiers',
        requiredParams: [],
   ...
   */
  async get(id: number): Promise<ApiResponse<IWorkTypeModifiers>> {
    this.logger.info('Getting worktypemodifiers', { id });
   ...
   */
  async list(query: IWorkTypeModifiersQuery = {}): Promise<ApiResponse<IWorkTypeModifiers[]>> {
    this.logger.info('Listing worktypemodifiers', { query });
