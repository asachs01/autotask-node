 ...
 */
export class ActionTypes extends BaseEntity {
  private readonly endpoint = '/ActionTypes';
   ...
   */
  async get(id: number): Promise<ApiResponse<IActionTypes>> {
   ...
   */
  async list(query: IActionTypesQuery = {}): Promise<ApiResponse<IActionTypes[]>> {
