...
export class NotificationHistory extends BaseEntity {
  private readonly endpoint = '/NotificationHistory';
   ...
   */
  async get(id: number): Promise<ApiResponse<INotificationHistory>> {
   ...
   */
  async list(query: INotificationHistoryQuery = {}): Promise<ApiResponse<INotificationHistory[]>> {
