...
export type BatchStrategy = 
  | 'size-based'     // Batch by reaching size limit
  | 'time-based'     // Batch by timeout
  | 'hybrid'         // Combination of size and time
  | 'priority-aware' // Consider request priority
  | 'adaptive';      // Adapt based on system conditions
