 ...
 */
export class AutotaskWorkflows {
  /**
      ...
      steps: [
        {
          ...
          action: async (context) => {
            ...
            if (hoursOverdue > 24) escalationLevel = 3;
            else if (hoursOverdue > 8) escalationLevel = 2;
            else if (ticket.priority === 4) escalationLevel = 2;
      ...
      steps: [
        {
          ...
          action: async (context) => {
            ...
            if (timeEntry.hoursWorked > 12) approvalPath = 'executive';
            else if (timeEntry.hoursWorked > 8) approvalPath = 'manager';
            else if (timeEntry.isBillable) approvalPath = 'billing';
   ...
   */
  private static isWeekendWork(dateWorked: string): boolean {
