...
import { EntityRelationship, RelationshipType, LoadingStrategy } from '../types/RelationshipTypes';

export class AutotaskRelationshipDefinitions {
   ...
   */
  public static getAllRelationships(): EntityRelationship[] {
   ...
   */
  public static getRelationshipsForEntity(entityName: string): EntityRelationship[] {
    return this.relationships.filter(rel => 
      rel.sourceEntity === entityName || rel.targetEntity === entityName
    );
  }
   ...
   */
  public static getOutgoingRelationships(entityName: string): EntityRelationship[] {
   ...
   */
  public static getIncomingRelationships(entityName: string): EntityRelationship[] {
   ...
   */
  public static getRelationshipById(relationshipId: string): EntityRelationship | undefined {
   ...
   */
  public static getDirectRelationship(sourceEntity: string, targetEntity: string): EntityRelationship | undefined {
   ...
   */
  public static getCoreEntities(): string[] {
    return [
      'Companies',
      'Contacts',
      'Tickets',
   ...
   */
  public static getHighCascadeRiskEntities(): string[] {
    const entityDependentCounts = new Map<string, number>();
